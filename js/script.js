const ApiKey = "9392cc38b76e4243b5dd1113fec15105";
            ...
            teams += `
                ...
                <div class="row">
                    <div class="card-image">
                        <img src="${restJson.crestUrl}"width="20%" height="20%" style="display: block; margin: auto;">
                        <h3>${restJson.name}</h3>
                    </div>
                    <div class="col s8">
                            <li class="collection-item">Nama Club : ${restJson.shortName}</li>
                            <li class="collection-item">Berdiri : ${restJson.founded}</li>
                            <li class="collection-item">Asal : ${restJson.address}</li>
                            <li class="collection-item">Email : ${restJson.email}</li>
                            <li class="collection-item">Markas : ${restJson.venue}</li>
                            <li class="collection-item">Warna Club : ${restJson.clubColors}</li>
                    </div>
                </div>
                </div>
                `;
